#ifndef JOJ_D3D11_RENDERER_2D_H
#define JOJ_D3D11_RENDERER_2D_H
...
namespace joj
{
    ...
    inline ID3D11Device* D3D11Renderer2D::get_device() const
    { return m_device; }

    inline ID3D11DeviceContext* D3D11Renderer2D::get_device_context() const
    { return m_device_context; }

    inline ID3D11DepthStencilView* D3D11Renderer2D::get_depth_stencil_view() const
    { return m_depth_stencil_view; }

    inline ID3D11RenderTargetView* D3D11Renderer2D::get_render_target_view() const
    { return m_render_target_view; }
}

#endif // JPLATFORM_WINDOWS

#endif // JOJ_D3D11_RENDERER_2D_H