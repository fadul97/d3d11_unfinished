#ifndef JOJ_FREE_CAMERA_OLD_H
#define JOJ_FREE_CAMERA_OLD_H
...
namespace joj
{
    ...
    class JAPI FreeCameraOld
    {
    public:
        FreeCameraOld(JFloat3 pos = JFloat3{ 0.0f, 0.0f, 0.0f }, JFloat3 up = JFloat3{ 0.0f, 1.0f, 0.0f }, f32 yaw = YAW, f32 pitch = PITCH);
        ~FreeCameraOld();
    ...
    inline JMatrix4x4 FreeCameraOld::get_view_mat() const
    {
