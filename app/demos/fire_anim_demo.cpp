...
void FireAnimationDemo::build_texture()
{
	// ---------------------------------------------------
	// Create DDS Texture
	// ---------------------------------------------------
	...
	{
		JERROR(joj::ErrorCode::FAILED, "Failed to create DDS Texture from file 'fire_animation_atlas.dds'.");
	}
	else
	{
...
void FireAnimationDemo::build_geometry_buffers()
{
...
void FireAnimationDemo::build_shaders()
{
...
void FireAnimationDemo::build_vertex_layout()
{
...
void FireAnimationDemo::build_constant_buffers()
{
	// ---------------------------------------------------
...
void FireAnimationDemo::update(const f32 dt)
{
...
void FireAnimationDemo::shutdown()
{
