...
joj::FreeCamera::FreeCamera(JFloat3 pos, JFloat3 up, f32 yaw, f32 pitch)
...
void joj::FreeCamera::process_keyboard(CameraMovement direction, f32 dt)
{
...
void joj::FreeCamera::process_mouse_movement(f32 xoffset, f32 yoffset, b8 constrain_pitch)
{
...
void joj::FreeCamera::process_mouse_scroll(f32 yoffset)
{
    m_zoom -= yoffset;
    if (m_zoom < 1.0f)
        m_zoom = 1.0f;
...
void joj::FreeCamera::update_camera_vectors()
{
