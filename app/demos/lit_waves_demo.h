#ifndef LIT_WAVES_DEMO_H
#define LIT_WAVES_DEMO_H
...
class LitWavesDemo : public joj::App
{
public:
	void init();
...
public:
	...
	joj::DirectionalLight m_dir_light;
	joj::PointLight m_point_light;
	joj::SpotLight m_spot_light;
